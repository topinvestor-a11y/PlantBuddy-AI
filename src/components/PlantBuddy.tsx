                  ...
                  <div className="bg-white p-8 md:p-12 rounded-[2rem] shadow-xl border border-emerald-50">
                    ...
                    <div className="mt-12 pt-8 border-t border-slate-100 flex flex-col md:flex-row items-center justify-between gap-6">
                      <div className="flex items-center gap-4 text-slate-400 italic">
                        ...
                        <span>식물은 당신의 정성을 배신하지 않아요.</span>
                      </div>
                      <button 
                        onClick={reset}
                        className="px-8 py-4 bg-slate-900 text-white rounded-2xl font-bold hover:bg-emerald-800 transition-all flex items-center gap-2"
                      >
                        <RefreshCcw size={18} />
                        다시 테스트하기
                      </button>
